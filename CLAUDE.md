...
`utils/`, plus the root-level `README.md`, `AGENTS.md` and this file, is reviewed on every pull
request and every implementation, and whatever the change affects is updated in that same PR.
Reviewing a file and concluding it needs no change is fine. Not looking is not.
...
The canonical statement of the rule, with the full file table, is §9.0 of
